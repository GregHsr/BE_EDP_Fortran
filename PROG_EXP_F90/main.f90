program main
 ...
 real,dimension(:,:),allocatable :: x,y,x_irreg,y_irreg              ! Coordinates of the bottom-left corner of the temperature cell (in meter)
 ...
 real :: dt, test                                                          ! Time step (in second)
 ...
 test = param%D*dt/((param%Ly/param%ny)*(param%Ly/param%ny))
 print*, test
